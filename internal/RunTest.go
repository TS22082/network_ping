...
func RunTest(cfg PingTestConfig) {
	...
	// pinger.OnSend (OnRecv, OnFinish, etc.) are callback functions that handle events during the ping test
	...
	pinger.OnFinish = func(stats *probing.Statistics) {
		...
		// A log will still happen after with the full stats. They can sorted
		// together using the client ID on logida dashboard.
	...
	// Start the ping test. Once pinger.Run() is called the OnSend, OnRecv, and OnFinish
	// callbacks will be triggered. https://github.com/prometheus-community/pro-bing
